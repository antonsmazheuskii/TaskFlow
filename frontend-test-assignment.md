...
-----
## FAQ
**Q: Можно использовать другие библиотеки?** A: Да. Стек (React + TypeScript + Supabase) фиксирован, всё остальное — на ваш выбор.

**Q: Обязательно ли делать всё?** A: Нет. MVP (Уровень 1) — обязательный минимум. Каждый дополнительный уровень — плюс при оценке.

**Q: Что если не успеваю?** A: Лучше качественный MVP, чем незаконченный полный функционал. Опишите в README, что планировали, но не успели.
